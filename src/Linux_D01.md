...
>
  ...
  - Размер swap: 1563644 килобайтах.
...
- *Значения*:
  ...
  - Занято памяти: 4612244 КБ.
  - Свободно памяти: 3347492 КБ.
  - Процент использования памяти: 58%.

*Единица измерения в выводе команды **df** по умолчанию — блоки размером 1K (**килобайт**).*
...
- *Значения*:
  ...
  - Занято памяти: 4.4 ГБ.
  - Свободно памяти: 3.2 ГБ.
  - Процент использования памяти: 58%.
  - Тип файловой системы: ext4.

*С флагом **-Th** команда **df** отображает информацию о дисковом пространстве в удобных для чтения форматах (human-readable) и показывает тип файловой системы. Единицы измерения при использовании этого флага могут быть в **килобайтах** (K), **мегабайтах** (M), **гигабайтах** (G) и т.д., в зависимости от размера раздела.*
